...
class ResNeXt(object):
    ...
    def resnext_layers_proto(self, batch_size, card=32, phase='TRAIN', stages=(3, 4, 23, 3)):
        """
        ...
        n.data, n.label = L.Data(source=source_data, backend=P.Data.LMDB, batch_size=batch_size, ntop=2,
                                 transform_param=dict(crop_size=112, mean_value=[104, 117, 123], mirror=mirror))
        ...
        n.pool1 = L.Pooling(n.conv1, kernel_size=3, stride=2, pad=1, pool=P.Pooling.MAX)  # 64x56x56
...
proto = ResNeXt("", "", 219)
p = proto.resnext_layers_proto(32)
print p
