...
% Aktiviere die Sprachunterstützung und evtl. auch die Sprache:
% Die Sprache kann auch später mit Hilfe der Variable
% UseTranslation neu gesetzt werden
\input{PreambleFiles/multilang}

% Setze Sprache:
% (Diese Variable kann je nach bedarf später neu gesetzt werden):
...
\input{PreambleFiles/UsePackages}

% Pfade für Videos und Bilder setzen
% Dies ist dafür gemacht
\input{PreambleFiles/paths}
...
\input{PreambleFiles/AuthorAndTitle}


\input{PreambleFiles/AuxiliaryMacros}
\input{PreambleFiles/Macros}
...
%------------------------------
\begin{frame}[c]
	\frametitle{\transl{Outline}{Gliederung}}
	\tableofcontents
	[hideallsubsections]
%	[pausesections]
\hypertarget<.>{Outline}{}
...
\input{Frames/01-RequirementsDefinition}
\input{Frames/06-End}
\input{Frames/appendix}
